...
class MaxSoftHeap {
    ...
    static makeRoot(elem) {
        ...
        const node = new Vertex(elem);
        this.animator.moveAllNodesBy(50, 0);
        node.elements.node = this.animator.addNode(elem.key.toString(), ((_a = this.H) === null || _a === void 0 ? void 0 : _a.elements.tree) ? this.H.elements.tree.getBounds().minX - 50 : this.animator.startX / 2, ((_b = this.H) === null || _b === void 0 ? void 0 : _b.elements.tree) ? this.H.elements.node.position.y : this.animator.startY / 2, {
            key: node.key,
            rank: node.rank,
            set: node.setToString()
        });
