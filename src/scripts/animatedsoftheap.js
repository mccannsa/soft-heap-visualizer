...
class SoftHeap {
  ...
  static insert(heap, elem) {
    ...
    const dx =
      ...
      ((_a = ret.elements.tree) === null || _a === void 0 ? void 0 : _a.getBounds().minX);
...
class MaxSoftHeap {
  ...
  static makeRoot(elem) {
    ...
    node.elements.node = this.animator.addNode(
      elem.key.toString(),
      ((_a = this.H) === null || _a === void 0 ? void 0 : _a.elements.tree)
        ? this.H.elements.tree.getBounds().minX - 50
        : this.animator.startX / 2,
      ((_b = this.H) === null || _b === void 0 ? void 0 : _b.elements.tree)
        ? this.H.elements.node.position.y
